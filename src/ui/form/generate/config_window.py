...
class Ui_ConfigWindow(object):
    def setupUi(self, ConfigWindow):
        ...
        sizePolicy.setHeightForWidth(self.combo_box_audio_output.sizePolicy().hasHeightForWidth())
        self.combo_box_audio_output.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_udp_port.sizePolicy().hasHeightForWidth())
        self.label_udp_port.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.line_edit_server_address.sizePolicy().hasHeightForWidth())
        self.line_edit_server_address.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.combo_box_audio_driver.sizePolicy().hasHeightForWidth())
        self.combo_box_audio_driver.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.line_edit_udp_port.sizePolicy().hasHeightForWidth())
        self.line_edit_udp_port.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.line_edit_account.sizePolicy().hasHeightForWidth())
        self.line_edit_account.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_audio_input.sizePolicy().hasHeightForWidth())
        self.label_audio_input.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.combo_box_audio_input.sizePolicy().hasHeightForWidth())
        self.combo_box_audio_input.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.line_edit_tcp_port.sizePolicy().hasHeightForWidth())
        self.line_edit_tcp_port.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_log_level.sizePolicy().hasHeightForWidth())
        self.label_log_level.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_audio_output.sizePolicy().hasHeightForWidth())
        self.label_audio_output.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.button_ptt.sizePolicy().hasHeightForWidth())
        self.button_ptt.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_account.sizePolicy().hasHeightForWidth())
        self.label_account.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_tcp_port.sizePolicy().hasHeightForWidth())
        self.label_tcp_port.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_server_address.sizePolicy().hasHeightForWidth())
        self.label_server_address.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_ptt.sizePolicy().hasHeightForWidth())
        self.label_ptt.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_audio_driver.sizePolicy().hasHeightForWidth())
        self.label_audio_driver.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.label_config_version.sizePolicy().hasHeightForWidth())
        self.label_config_version.setSizePolicy(sizePolicy1)
        ...
        self.layout_form.addWidget(self.label_config_version_2, 0, 1, 1, 2)
        ...
        sizePolicy.setHeightForWidth(self.combo_box_log_level.sizePolicy().hasHeightForWidth())
        self.combo_box_log_level.setSizePolicy(sizePolicy)

        self.layout_form.addWidget(self.combo_box_log_level, 1, 1, 1, 2)
